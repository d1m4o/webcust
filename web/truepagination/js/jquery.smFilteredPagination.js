...
;(function($) {
    $.smFilteredPagination = function(el, options) {
        ...
        var defaults = {
            ...
            itemsInPagerEdge: 3,                // max items displayed in pager edges (didn't do this yet)
            ...
            showFirst: false,                    // show "first"
            showPrev: false,                     // show "prev"
            showNext: false,                     // show "next"
            showLast: false,                     // show "last"
